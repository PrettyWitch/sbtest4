...
import com.yuhan.booking.exceptions.CarProcessException;
import com.yuhan.booking.exceptions.PaymentProcessException;
import com.yuhan.booking.exceptions.RentProcessException;
...
/**
 * @author yuhan
 * @date 04.06.2021 - 15:29
 * @purpose
 */
@Hidden
@RestControllerAdvice(annotations = RestControllerAdvice.class)
public class ExceptionController {
    private static final Logger logger = LoggerFactory.getLogger(com.yuhan.car.web.ExceptionController.class);
    ...
    @ExceptionHandler(value = {
            CarProcessException.class,
            PaymentProcessException.class,
            RentProcessException.class
    })
