...
import com.yuha.report.exception.BookingProcessException;
import com.yuhan.rent.exception.ErrorResponse;
import com.yuhan.rent.exception.NotFoundException;
...
/**
 * @author yuhan
 * @date 06.06.2021 - 15:27
 * @purpose
 */
@Hidden
@RestControllerAdvice(annotations = {RestController.class})
public class ExceptionController {
    private static final Logger logger = LoggerFactory.getLogger(com.yuhan.rent.web.ExceptionController.class);
